...
define(SERVER_ROOT,($_SERVER[HTTPS]?"https://":"http://").SERVER_NAME.((SERVER_PORT==80)?"":(":".SERVER_PORT)).dirname(SERVER_ADD));//记录客户端根目录
...
define(DIR_SYSTEM,DIR_ROOT.DIRECTORY_SEPARATOR."System".DIRECTORY_SEPARATOR);
define(DIR_LIB,DIR_ROOT.DIRECTORY_SEPARATOR."Lib".DIRECTORY_SEPARATOR);
define(DIR_HOME,DIR_ROOT.DIRECTORY_SEPARATOR."Home".DIRECTORY_SEPARATOR);
define(DIR_LOGS,DIR_ROOT.DIRECTORY_SEPARATOR."Logs".DIRECTORY_SEPARATOR);
define(DIR_COMMON,DIR_ROOT.DIRECTORY_SEPARATOR."Common".DIRECTORY_SEPARATOR);
define(DIR_MODELS,DIR_ROOT.DIRECTORY_SEPARATOR."Models".DIRECTORY_SEPARATOR);
define(DIR_COMPONENTS,DIR_ROOT.DIRECTORY_SEPARATOR."Components".DIRECTORY_SEPARATOR);
/*
 * 加载数据库信息
 */
